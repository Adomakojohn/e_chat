...
class AppColors {
  ...
  static final MaterialColor gray =
      MaterialColor(const Color(0xFF71717A).value, const <int, Color>{
    50: Color(0xFFF9FAFB),
  ...
  static final MaterialColor red =
      MaterialColor(const Color(0xFFEF4444).value, const <int, Color>{
    50: Color(0xFFFEF2F2),
  ...
  /// `AppColor.lime[50]`
  /// `AppColors.lime.50`
  static final MaterialColor lime =
      MaterialColor(const Color(0xFF84CC16).value, const <int, Color>{
    50: Color(0xFFF7FEE7),
  ...
  /// `AppColor.teal[50]`
  /// `AppColors.teal.50`
  static final MaterialColor teal =
      MaterialColor(const Color(0xFF14B8A6).value, const <int, Color>{
    50: Color(0xFFF0FDFA),
  ...
  static final MaterialColor cyan =
      MaterialColor(const Color(0xFF06B6D4).value, const <int, Color>{
    50: Color(0xFFECFEFF),
  ...
  static final MaterialColor blue =
      MaterialColor(const Color(0xFF3B82F6).value, const <int, Color>{
    50: Color(0xFFEFF6FF),
  ...
  /// `AppColor.pink[50]`
  /// `AppColors.pink.50`
  static final MaterialColor pink =
      MaterialColor(const Color(0xFFEC4899).value, const <int, Color>{
    50: Color(0xFFFDF2F8),
  ...
  /// `AppColor.rose[50]`
  /// `AppColors.rose.50`
  static final MaterialColor rose =
      MaterialColor(const Color(0xFFF43F5E).value, const <int, Color>{
    50: Color(0xFFFFF1F2),
